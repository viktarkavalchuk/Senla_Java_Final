...
-- -----------------------------------------------------
-- Table `Private_announcements`.`User_Security`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `Private_announcements`.`User_Security` ;

CREATE TABLE IF NOT EXISTS `Private_announcements`.`User_Security` (
  `idUser_Security` INT NOT NULL AUTO_INCREMENT,
  `login` VARCHAR(45) NULL,
  `password` VARCHAR(45) NULL,
  `idUser` INT NULL,
  PRIMARY KEY (`idUser_Security`),
  INDEX `idUser-Security_idx` (`idUser` ASC),
  CONSTRAINT `idUser_Security`
    FOREIGN KEY (`idUser`)
    REFERENCES `Private_announcements`.`User` (`id_User`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `Private_announcements`.`User_Role` (
  ...
  CONSTRAINT `UserSecurity`
    FOREIGN KEY (`user`)
    REFERENCES `Private_announcements`.`User_Security` (`idUser_Security`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
START TRANSACTION;
USE `Private_announcements`;
INSERT INTO `Private_announcements`.`User` (`id_User`, `name`, `email`, `telephone_Number`) VALUES (1, 'Admin', 'email@mail.com', '+3752912345678');
INSERT INTO `Private_announcements`.`User` (`id_User`, `name`, `email`, `telephone_Number`) VALUES (2, 'User_1', 'user_1@mail.com', '+3752912345679');
INSERT INTO `Private_announcements`.`User` (`id_User`, `name`, `email`, `telephone_Number`) VALUES (3, 'User_2', 'user_2@mail.com', '+3752912345680');
INSERT INTO `Private_announcements`.`User` (`id_User`, `name`, `email`, `telephone_Number`) VALUES (4, 'User_3', 'user_3@mail.com', '+3752912345681');
...
-- -----------------------------------------------------
-- Data for table `Private_announcements`.`User_Security`
-- -----------------------------------------------------
START TRANSACTION;
USE `Private_announcements`;
INSERT INTO `Private_announcements`.`User_Security` (`idUser_Security`, `login`, `password`, `idUser`) VALUES (1, 'Admin', '123', 1);
INSERT INTO `Private_announcements`.`User_Security` (`idUser_Security`, `login`, `password`, `idUser`) VALUES (2, 'User1', '111', 2);
INSERT INTO `Private_announcements`.`User_Security` (`idUser_Security`, `login`, `password`, `idUser`) VALUES (3, 'User2', '111', 3);
INSERT INTO `Private_announcements`.`User_Security` (`idUser_Security`, `login`, `password`, `idUser`) VALUES (4, 'User3', '111', 4);
...
START TRANSACTION;
USE `Private_announcements`;
INSERT INTO `Private_announcements`.`Rating` (`idRating`, `toUser`, `fromUser`, rating) VALUES (1, 2, 2, 5);
