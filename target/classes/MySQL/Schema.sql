...
START TRANSACTION;
USE `Private_announcements`;
INSERT INTO `Private_announcements`.`Announcement` (`id_Announcement`, `name`, `price`, `startDate`, `soldDate`, `description`, `vip`, `sold`, `user_Id`, `rating_user`) VALUES (1, 'Vacuum cleaner BOSCH', 50, '2022-01-20', NULL, 'Почти новый, на гарантии', 0, 0, 2, 5.0);
INSERT INTO `Private_announcements`.`Announcement` (`id_Announcement`, `name`, `price`, `startDate`, `soldDate`, `description`, `vip`, `sold`, `user_Id`, `rating_user`) VALUES (2, 'TV LG', 250, '2022-01-20', '2022-03-01', NULL, 1, 1, 3, 5.0);
INSERT INTO `Private_announcements`.`Announcement` (`id_Announcement`, `name`, `price`, `startDate`, `soldDate`, `description`, `vip`, `sold`, `user_Id`, `rating_user`) VALUES (3, 'Pump', 10, '2022-01-20', NULL, NULL, 0, 0, 4, 5.0);
INSERT INTO `Private_announcements`.`Announcement` (`id_Announcement`, `name`, `price`, `startDate`, `soldDate`, `description`, `vip`, `sold`, `user_Id`, `rating_user`) VALUES (4, 'PC', 500, '2022-01-20', NULL, NULL, 0, 0, 4, 5.0);
...
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (3, 1, 2, 'Объявление размещено');
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (4, 2, 4, '1');
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (5, 3, 1, 'Как изменить пароль?');
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (6, 4, 1, 'Можно восстановить пароль? На почту?');
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (7, 1, 3, 'Спасибо');
INSERT INTO `Private_announcements`.`Chat` (`idChat`, `chatSender`, `chatRecipient`, `message`) VALUES (8, 3, 2, 'Продано');
